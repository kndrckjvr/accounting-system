...
<div class="form-group">
    ...
    <input type="text" name="basic_pay" id="basic_pay" class="form-control{{ ($errors->has('basic_pay')) ? ' is-invalid' : '' }}" value="{{ old('basic_pay') ?? ($employee->current_basic_pay == null) ? '' : $employee->current_basic_pay->amount }}">
